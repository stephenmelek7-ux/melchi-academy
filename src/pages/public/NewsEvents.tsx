...
const NewsEvents: React.FC = () => {
  ...
  const newsItems = [
    {
      id: 1,
      title: 'Melchi Academy Wins National Debate Competition',
      date: 'December 10, 2024',
      category: 'news',
      excerpt: 'Our debate team emerged victorious at the National Schools Debate Championship, defeating 50 schools from across the country.',
    ...
    },
    {
      ...
      category: 'news',
      excerpt: 'We are proud to announce the opening of our new state-of-the-art science laboratory, equipped with modern equipment for practical learning.',
    ...
    },
    {
      ...
      category: 'news',
      excerpt: 'Our students achieved outstanding results in the national examinations, with a 98% pass rate and 15 students scoring above 90%.',
    ...
    },
    {
      ...
      category: 'events',
      excerpt: 'Join us for our annual Sports Day on December 15th. Students will compete in various athletic events and team games.',
      image: 'https://images.unsplash.com/photo-1571260899304-425eee4c7efc?w=600&h=400&fit=crop',
      location: 'Melchi Academy Sports Complex',
    ...
    },
    {
      ...
      category: 'events',
      excerpt: 'Experience the rich diversity of our school community at the annual Cultural Day celebration.',
      image: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?w=600&h=400&fit=crop',
      location: 'Melchi Academy Auditorium',
    ...
    },
    {
      ...
      category: 'events',
      excerpt: 'Parents are invited to meet with teachers to discuss student progress and academic performance.',
      image: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=600&h=400&fit=crop',
      location: 'Melchi Academy Hall',
      time: '8:30 AM - 2:00 PM'
    }
  ]

  const filteredItems = activeTab === 'news' 
    ? newsItems.filter(item => item.category === 'news')
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm fixed w-full z-50">
        <div className="container-custom py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/news-events" className="text-gray-700 hover:text-primary-600 font-semibold">News & Events</Link>
      ...
      <section className="pt-20 bg-gradient-to-r from-primary-600 to-secondary-500 text-white py-20">
        <div className="container-custom text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">Stay updated with the latest happenings at Melchi Academy</p>
        </div>
      </section>
        ...
        <div className="container-custom">
              ...
              <div key={item.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                    ...
                    {item.category === 'news' && (
                      <span className="text-sm text-gray-500">✍️ {item.author}</span>
                    )}
                  </div>
                </div>
              </div>
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">No {activeTab === 'news' ? 'news' : 'events'} found.</p>
            </div>
          )}
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><Link to="/news-events" className="hover:text-white transition">News & Events</Link></li>
