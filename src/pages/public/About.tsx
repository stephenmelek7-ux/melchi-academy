  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4">Proprietor's Welcome</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Welcome to Melchi Academy, a place where we nurture young minds 
              and build character. Our commitment to excellence in education 
              is unwavering, and we strive to create an environment where every 
              child can thrive.
            </p>
            <p className="text-gray-600 leading-relaxed">
              We believe in the holistic development of each student, ensuring 
              they are well-prepared for the challenges of the future while 
              maintaining strong moral and spiritual values.
            </p>
            <div className="mt-6">
              <p className="font-bold text-gray-800">Mr. Melchi Johnson</p>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4">Principal's Welcome</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              It is my privilege to welcome you to Melchi Academy. Our dedicated 
              team of educators is committed to providing the highest quality 
              education in a supportive and nurturing environment.
            </p>
            <p className="text-gray-600 leading-relaxed">
              At Melchi Academy, we focus on developing the whole child - 
              academically, morally, spiritually, and socially. We work closely 
              with parents and guardians to ensure every student reaches their 
              full potential.
            </p>
            <div className="mt-6">
              <p className="font-bold text-gray-800">Dr. Grace Adeyemi</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ul className="text-gray-600 space-y-3">
              ...
              <li className="flex items-start">
                <span className="text-primary-600 mr-3 font-bold text-xl">✓</span>
                <div>
                  <strong>Integrity</strong> - Upholding honesty and moral principles
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-primary-600 mr-3 font-bold text-xl">✓</span>
                <div>
                  <strong>Respect</strong> - Treating all individuals with dignity and worth
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-primary-600 mr-3 font-bold text-xl">✓</span>
                <div>
                  <strong>Discipline</strong> - Cultivating self-control and dedication
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-primary-600 mr-3 font-bold text-xl">✓</span>
                <div>
                  <strong>Compassion</strong> - Showing kindness and service to others
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary-600 transition">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.104c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                </a>
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary-600 transition">
