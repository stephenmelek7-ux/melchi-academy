...
const Prospectus: React.FC = () => {
  const sections = [
    {
      title: 'About Melchi Academy',
      description: 'Learn about our history, vision, mission, and core values that make Melchi Academy a unique institution.',
      icon: '🏫'
    },
    {
      title: 'Academic Programmes',
      description: 'Detailed information about our Nursery, Primary, and Secondary school programmes and curriculum.',
      icon: '📚'
    },
    {
      title: 'Admissions Process',
      description: 'Step-by-step guide on how to enroll your child, including requirements, deadlines, and fees.',
      icon: '📝'
    },
    {
      title: 'School Facilities',
      description: 'Explore our state-of-the-art facilities including classrooms, laboratories, library, and sports complex.',
      icon: '🔬'
    },
    {
      title: 'Extracurricular Activities',
      description: 'Discover the wide range of sports, arts, clubs, and societies available to our students.',
      icon: '⚽'
    },
    {
      title: 'Parent Information',
      description: 'Essential information for parents including school policies, uniform, transportation, and communication.',
      icon: '👨‍👩‍👧‍👦'
    }
  ]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm fixed w-full z-50">
        <div className="container-custom py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/prospectus" className="text-gray-700 hover:text-primary-600 font-semibold">Prospectus</Link>
      ...
      <section className="pt-20 bg-gradient-to-r from-primary-600 to-secondary-500 text-white py-20">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">School Prospectus</h1>
          <p className="text-xl max-w-3xl mx-auto">Your comprehensive guide to everything Melchi Academy has to offer</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-primary-50 rounded-2xl p-8 border-2 border-dashed border-primary-300">
              <div className="text-6xl mb-4">📄</div>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Download Our Prospectus</h2>
              <p className="text-gray-600 mb-6">
                Get detailed information about our school, programmes, facilities, and admission process.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link 
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    alert('Prospectus download will be available soon. Please check back later or contact the admissions office.')
                  }}
                >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-4">What's Inside the Prospectus</h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            Our prospectus contains everything you need to know about Melchi Academy
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-4">Request a Hard Copy</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  If you prefer a printed version of our prospectus, please fill out the form or visit our admissions office.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="text-primary-600">📍</span>
                    <span className="text-gray-600">123 Education Street, City, Country</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-primary-600">📞</span>
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-primary-600">📧</span>
                    <span className="text-gray-600">admissions@melchiacademy.edu</span>
                  </div>
                </div>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-800 mb-4">Request Form</h3>
                <form onSubmit={(e) => {
                  e.preventDefault()
                  alert('Thank you! Your prospectus request has been submitted. We will contact you shortly.')
                }}>
                  <div className="space-y-4">
                    <div>
                      <label className="label-field">Full Name *</label>
                      <input type="text" required className="input-field" placeholder="Enter your full name" />
                    </div>
                    <div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-secondary-500 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Join Melchi Academy?</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><Link to="/prospectus" className="hover:text-white transition">Prospectus</Link></li>
